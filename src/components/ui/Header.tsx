      ...
      <div className="header-inner">
        <div className="header-left">
          <Link to={routesName.ROOT} className="logo-link">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 46.719 46.641" width={32} height={32} className="logo-img">
            ...
            <span className="logo-text">AnomaSwap</span>
          </Link>
        ...
        <div className="header-right">
          <button className="buy-cake-btn">Buy $XAN</button>
          <DarkModeToggle />
          <LanguageSelector />
          <NetworkSelector />
          <ConnectWallet />
